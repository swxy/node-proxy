...
let stylize = (style, str) => {
    let current = color[style];
...
exports.on = {
    debug: function(msg) {
        process.stdout.write(`${stylize('grey', '[DEBUG]')}  ${msg} \n`);
    },
    notice: function(msg) {
        process.stdout.write(`${stylize('cyan', '[INFO]')}  ${msg} \n`);
    },
    warning: function(msg) {
        process.stdout.write(`${stylize('yellow','[WARNING]')}  ${msg} \n`);
    },
    error: function(msg) {
        process.stdout.write(`${stylize('red', '[ERROR]')}  ${msg} \n`);
    }
};
